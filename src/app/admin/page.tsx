...
const AdminMap = dynamic(() => import('@/components/AdminMap').then(mod => mod.AdminMap), {
  ...
  loading: () => (
    <div className="absolute inset-0 flex items-center justify-center bg-[#050A0F]">
      <span className="text-[#00D4FF] font-mono text-xs animate-pulse">BOOTING GEO-GRID...</span>
    </div>
  )
});
...
const MOCK_TICKETS: Ticket[] = [
  {
    ...
    before_image_url: 'https://images.unsplash.com/photo-1595278069441-2f03f3fb1c53?q=80&w=400&auto=format&fit=crop',
  ...
  },
  {
    ...
    before_image_url: 'https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?q=80&w=400&auto=format&fit=crop',
    after_image_url: null,
    upvote_count: 8,
    frt_deadline: new Date().toISOString(),
    sla_deadline: new Date().toISOString(),
  ...
  },
  {
    ...
    before_image_url: 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15f?q=80&w=400&auto=format&fit=crop',
    after_image_url: null,
    upvote_count: 22,
    frt_deadline: new Date().toISOString(),
    sla_deadline: new Date().toISOString(),
  ...
  },
  {
    ...
    status: 'open',
    ai_confidence: 0.58,
    ai_label: 'Broken Sign / Outage?',
    before_image_url: 'https://images.unsplash.com/photo-1616428456627-c102a2eb3cc1?q=80&w=400&auto=format&fit=crop',
    after_image_url: null,
    upvote_count: 5,
    frt_deadline: new Date().toISOString(),
    sla_deadline: new Date().toISOString(),
    ...
    severity: null,
    proof_of_work_hash: null,
    reporter: { display_name: 'NightDriver' },
  },
  {
    id: '8496',
    status: 'open',
    ai_confidence: 0.39,
    ai_label: 'Overgrown / Obscured',
    before_image_url: 'https://images.unsplash.com/photo-1591852656972-e1d88a10ffcb?q=80&w=400&auto=format&fit=crop',
    after_image_url: null,
    upvote_count: 11,
    frt_deadline: new Date().toISOString(),
    sla_deadline: new Date().toISOString(),
